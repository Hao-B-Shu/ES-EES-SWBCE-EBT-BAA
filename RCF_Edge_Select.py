...
class RCF_Edge_ES_Extractor(nn.Module):# Ordinary model and also the extractor of ES, output [Ordinary output, torch.cat(Ordinary output)]
    def __init__(self,device='cpu'):
        super(RCF_Edge_ES_Extractor, self).__init__()
